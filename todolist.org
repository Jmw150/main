...
** study for FINAL
||done|| how to calculate 2-complement
||done|| *** how to convert instructions to machine code
r-type(op,rt,rs,rd,sham,func)(6,5,5,5,5,6)
i-type(op,rt,rs,imm)(6,5,5,rest)
j-type(op,tag)(6,rest)
j address	PC ← {(PC + 4)[31:28], address, 00}
||done|| *** how to calculate execution time
||done|| *** remember ieee 754 standard
*** look up what each instruction does
** read ch2-4.4
* stats
