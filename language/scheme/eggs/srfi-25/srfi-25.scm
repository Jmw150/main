...
(define-inline (array:make vec ind shp) (##sys#make-structure 'array vec ind shp))
(define-inline (array:array? x) (##sys#structure? x 'array))
(define-inline (array:vector a) (##sys#slot a 1))
(define-inline (array:index a) (##sys#slot a 2))
(define-inline (array:shape a) (##sys#slot a 3))
