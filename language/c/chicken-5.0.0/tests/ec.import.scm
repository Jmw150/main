;;;; ec.import.scm - GENERATED BY CHICKEN 5.0.0 -*- Scheme -*-
...
(##sys#register-compiled-module
  ...
  'ec
  (scheme#list
    '(ec-:vector-filter . ec#ec-:vector-filter)
  ...
  (scheme#list
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((any?-ec (nested q1 ...) q etc1 etc ...)
         (any?-ec (nested q1 ... q) etc1 etc ...))
        ((any?-ec q1 q2 etc1 etc ...) (any?-ec (nested q1 q2) etc1 etc ...))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((ec-guarded-do-ec stop (nested gen q ...) cmd)
         (do-ec (:until gen stop) (ec-guarded-do-ec stop (nested q ...) cmd)))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((first-ec default expression) (first-ec default (nested) expression))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((last-ec default expression) (last-ec default (nested) expression))
    ...
    (scheme#cons
      'sum-ec
      (syntax-rules () ((sum-ec etc1 etc ...) (fold-ec (+) etc1 etc ... +))))
    (scheme#cons
      'vector-of-length-ec
      (syntax-rules
        (nested)
        ...
        ((vector-of-length-ec k qualifier expression)
         (let ((len k))
           (let ((vec (make-vector len)) (i 0))
             (do-ec qualifier
                    (if (< i len)
                      (begin (vector-set! vec i expression) (set! i (+ i 1)))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ()
        ((vector-ec etc1 etc ...) (list->vector (list-ec etc1 etc ...)))))
    (scheme#cons
      'string-append-ec
      (syntax-rules
        ()
    ...
    (scheme#cons
      ...
      (syntax-rules
        ()
        ((string-ec etc1 etc ...) (list->string (list-ec etc1 etc ...)))))
    (scheme#cons
      'append-ec
      (syntax-rules
        ()
        ((append-ec etc1 etc ...) (apply append (list-ec etc1 etc ...)))))
    (scheme#cons
      'list-ec
      (syntax-rules
        ()
        ((list-ec etc1 etc ...) (reverse (fold-ec '() etc1 etc ... cons)))))
    (scheme#cons
      'fold-ec
      (syntax-rules
        (nested)
        ...
        ((fold-ec x0 expression f2) (fold-ec x0 (nested) expression f2))
    ...
    (scheme#cons
      ...
      (syntax-rules
        (:do let)
        ((:generator-proc (g arg ...)) (g (:generator-proc var) var arg ...))
        ((:generator-proc
           var
           (:do (let obs oc ...)
                ((lv li) ...)
    ...
    (scheme#cons
      ...
      (syntax-rules
        (index)
        ((:dispatched cc var (index i) dispatch arg1 arg ...)
         (:parallel cc (:integers i) (:dispatched var dispatch arg1 arg ...)))
        ((:dispatched cc var dispatch arg1 arg ...)
         (:do cc
              (let ((d dispatch)
                    (args (list arg1 arg ...))
    ...
    (scheme#cons
      ...
      (syntax-rules
        (index)
        ((:real-range cc var arg1) (:real-range cc var (index i) 0 arg1 1))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((:range cc var arg1 arg2 1)
         (:do cc
              (let ((a arg1) (b arg2))
                (if (not (and (integer? a) (exact? a) (integer? b) (exact? b)))
                  (error "arguments of :range are not exact integer "
                         "(use :real-range?)"
                         a
                         b
              ...
              (let ((a arg1) (b arg2) (s arg3) (stop 0))
                (if (not (and (integer? a)
                  ...
                  (error "arguments of :range are not exact integer "
                         ...
                         b
                         s))
                (if (zero? s) (error "step size must not be zero in :range"))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((:while-2
           ...
           (ib-save ...)
           (ib-restore ...)
           (:do olet lbs ne1? (let ((ib-var ib-rhs) ib ...) ic ...) ne2? lss))
         (:while-2
           cc
           test
           (ib-let ... (ib-tmp #f))
    ...
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((:do cc lbs ne1? lss) (:do cc (let ()) lbs ne1? (let ()) #t lss))))
    (scheme#cons
      'do-ec:do
      (syntax-rules
        (:do let)
        ((do-ec:do
           cmd
           (:do (let obs oc ...) lbs ne1? (let ibs ic ...) ne2? (ls ...)))
         (ec-simplify
           (let obs oc
             ...
             (let loop lbs
  ...
  (scheme#list
    (scheme#cons
      ...
      (syntax-rules
        ...
        ((ec-simplify (let () command ...)) (ec-simplify (begin command ...)))
        ((ec-simplify (begin command ...)) (ec-simplify 1 () (command ...)))
