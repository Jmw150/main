;;;; chicken.compiler.support.import.scm - GENERATED BY CHICKEN 5.0.0 -*- Scheme -*-

(##sys#register-compiled-module
  'chicken.compiler.support
  'support
  (scheme#list)
  '((compiler-cleanup-hook . chicken.compiler.support#compiler-cleanup-hook)
    ...
    (with-debugging-output . chicken.compiler.support#with-debugging-output)
    (quit-compiling . chicken.compiler.support#quit-compiling)
    (emit-syntax-trace-info . chicken.compiler.support#emit-syntax-trace-info)
    (check-signature . chicken.compiler.support#check-signature)
    (stringify . chicken.compiler.support#stringify)
    (symbolify . chicken.compiler.support#symbolify)
    ...
    (expand-profile-lambda . chicken.compiler.support#expand-profile-lambda)
    (reset-profile-info-vector-name!
      .
      chicken.compiler.support#reset-profile-info-vector-name!)
    (profiling-prelude-exps . chicken.compiler.support#profiling-prelude-exps)
    ...
    (build-expression-tree . chicken.compiler.support#build-expression-tree)
    (fold-boolean . chicken.compiler.support#fold-boolean)
    (inline-lambda-bindings . chicken.compiler.support#inline-lambda-bindings)
    ...
    (dump-undefined-globals . chicken.compiler.support#dump-undefined-globals)
    ...
    (foreign-callback-stub? . chicken.compiler.support#foreign-callback-stub?)
    ...
    (foreign-callback-stubs . chicken.compiler.support#foreign-callback-stubs)
    ...
    (register-foreign-type! . chicken.compiler.support#register-foreign-type!)
    ...
    (finish-foreign-result . chicken.compiler.support#finish-foreign-result)
    ...
    (clear-real-name-table! . chicken.compiler.support#clear-real-name-table!)
