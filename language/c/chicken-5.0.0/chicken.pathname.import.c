...
if(C_unlikely(!C_demand_2(321))){
C_save(t1);
C_rereclaim2(321*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
...
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\022absolute-pathname\077\376\001\000\000#chicken.pathname#absolute-pathname\077\376\003\000\000\002\376\003"
