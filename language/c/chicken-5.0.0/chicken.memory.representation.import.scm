;;;; chicken.memory.representation.import.scm - GENERATED BY CHICKEN 5.0.0 -*- Scheme -*-
...
(##sys#register-compiled-module
  ...
  '((block-ref . chicken.memory.representation#block-ref)
    ...
    (extended-procedure? . chicken.memory.representation#extended-procedure?)
    (make-record-instance . chicken.memory.representation#make-record-instance)
    ...
    (record-instance-slot . chicken.memory.representation#record-instance-slot)
    (record-instance-slot-set!
      .
      chicken.memory.representation#record-instance-slot-set!)
    (record-instance-type . chicken.memory.representation#record-instance-type)
    (record-instance? . chicken.memory.representation#record-instance?)
    (set-procedure-data! . chicken.memory.representation#set-procedure-data!)
