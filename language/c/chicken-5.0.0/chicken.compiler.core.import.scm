;;;; chicken.compiler.core.import.scm - GENERATED BY CHICKEN 5.0.0 -*- Scheme -*-
...
(##sys#register-compiled-module
  ...
  '((analyze-expression . chicken.compiler.core#analyze-expression)
    (canonicalize-expression . chicken.compiler.core#canonicalize-expression)
    ...
    (build-toplevel-procedure . chicken.compiler.core#build-toplevel-procedure)
    ...
    (compiler-syntax-enabled . chicken.compiler.core#compiler-syntax-enabled)
    ...
    (enable-module-registration
      .
      chicken.compiler.core#enable-module-registration)
    ...
    (undefine-shadowed-macros . chicken.compiler.core#undefine-shadowed-macros)
    ...
    (linked-static-extensions . chicken.compiler.core#linked-static-extensions)
    ...
    (foreign-stub-return-type . chicken.compiler.core#foreign-stub-return-type)
    (lambda-literal-id . chicken.compiler.core#lambda-literal-id)
    (lambda-literal-external . chicken.compiler.core#lambda-literal-external)
    ...
    (lambda-literal-unboxed-temporaries
      .
      chicken.compiler.core#lambda-literal-unboxed-temporaries)
    (lambda-literal-callee-signatures
      .
      chicken.compiler.core#lambda-literal-callee-signatures)
    (lambda-literal-allocated . chicken.compiler.core#lambda-literal-allocated)
