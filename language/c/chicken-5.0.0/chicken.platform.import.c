...
if(C_unlikely(!C_demand_2(301))){
C_save(t1);
C_rereclaim2(301*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
...
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\016build-platform\376\001\000\000\037chicken.platform#build-platform\376\003\000\000\002\376\003\000\000\002\376\001\000\000\017"
