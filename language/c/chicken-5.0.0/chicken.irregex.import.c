...
if(C_unlikely(!C_demand_2(701))){
C_save(t1);
C_rereclaim2(701*sizeof(C_word),1);
t1=C_restore;}
a=C_alloc(3);
...
lf[3]=C_decode_literal(C_heaptop,C_text("\376\003\000\000\002\376\003\000\000\002\376\001\000\000\007irregex\376\001\000\000\027chicken.irregex#irregex\376\003\000\000\002\376\003\000\000\002\376\001\000\000\010irregex\077\376\001\000\000\030ch"
