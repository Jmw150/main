...
lf[1]=C_h_intern(&lf[1],12, C_text("\003sysbuild-id"));
lf[2]=C_decode_literal(C_heaptop,C_text("\376B\000\000\01012f2f2cc"));
lf[3]=C_h_intern(&lf[3],16, C_text("\003sysbuild-branch"));
lf[4]=C_h_intern(&lf[4],17, C_text("\003sysbuild-version"));
lf[5]=C_decode_literal(C_heaptop,C_text("\376B\000\000\0055.0.0"));
